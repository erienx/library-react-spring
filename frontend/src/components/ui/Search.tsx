...
const Search = ({ searchInp, setSearchInp, placeholder }: SearchProps) => {
  return (
    <div className='w-full max-w-4xl mx-auto py-4 px-3 bg-linear-to-t from-bg-lighter to-bg-lighter2 rounded-lg z-10 shadow-lg shadow-black/10 hover:shadow-black/20 transition-shadow duration-300'>
